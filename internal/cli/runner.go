...
func (r *Runner) printHelp() {
	r.logger.Printf("Commands: /init /permissions /verbose /context [/show] /ledger /status /plan /next /execute /assist /script /clean /ask /browse /links /read /ls /write /summarize /run /msf /report /resume /stop /exit")
