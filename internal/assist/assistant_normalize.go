...
func normalizeSuggestion(suggestion Suggestion) Suggestion {
	...
	suggestion.Decision = strings.ToLower(strings.TrimSpace(suggestion.Decision))
	...
	suggestion.WhyMet = strings.TrimSpace(suggestion.WhyMet)
	suggestion.Steps = normalizeSteps(suggestion.Steps)
	suggestion.EvidenceRefs = normalizeSteps(suggestion.EvidenceRefs)
